...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        while(choice != 0) {
            System.out.println(" 1) повторяем каждую букву в слове n раз");
            System.out.println(" 2) найдем разницу между максимальным и минимальным элементами массива");
            System.out.println(" 3) проверка среднего значения на целочисленность");
            System.out.println(" 4) просуммируем все предыдущие числа");
            System.out.println(" 5) узнаем количество знаков в дробной части числа");
            System.out.println(" 6) найдем значение числа Фибоначчи по его номеру");
            System.out.println(" 7) проверим строку на соответствие требованиям индекса");
            System.out.println(" 8) проверим являются ли строки странной парой");
            System.out.println(" 9) проверим приставку");
            System.out.println("10) проверим суффикс");
            System.out.println("11) проверим количество ходов");
