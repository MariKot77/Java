...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        while (choice != 0) {
            System.out.println("Выберите какую задачу решаем:");
    ...
    // Метод, для нахождения дискриминанта-> количества решений
    ...
    //Метод проверки на совершенность
    ...
    //Метод, поменяющий местами первый и последний символы
    ...
    //Метод, определяющий является ли строка допустимым шестнадцатиричным числом
    ...
    //Метод, находящий максимальное число подряд идущих нулей
    ...
    //Метод, ищущий количество уникальных элементов массива
    ...
    //Метод, находящий ближайшее простое число
    ...
    //Метод, проверка на числа Каприкар
    ...
    //Метод, проверяющий прямоугольный или нет треугольник
