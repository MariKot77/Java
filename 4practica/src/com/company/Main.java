...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        while(choice != 0) {
            System.out.println("Выберите какую задачу решим:");
    ...
    //Метод,находяший количество уникальных символов между повторяющимися
    ...
    //Метод, находящий мультипликативное постоянство
    ...
    //Метод, проверяющий повторяемость числа
    ...
    //Метод, вычисляющий индекс массы тела
    public static String BMI(float []n,String str) {
        ...
        if ((n[0]/(n[1]*n[1]))<18.5) return "Недостаток веса";
        else if ((n[0]/(n[1]*n[1]))>=25) return "Избыток веса";
        return "Нормальный вес";
    }

    //метод, преобразующий в звездную стенографию
