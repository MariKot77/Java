...
public class Main {
    ...
    //метод, проверяющий шаги шахматных фигур
    ...
    //метод, определяющий может ли быть законченным слово
    ...
    //метод, склядывающий и перемножающий числа
    ...
    //метод, ищущий все гласные, что есть в первом слове
    ...
    //метод - проверка банковской карты
    ...
    //метод, переворачивающий цифру в её буквенное представление(анг/рус)
    ...
    //метод - правильный регистр "Игры Престолов"
    ...
    //метод, рисующий гексагональную решетку
